...
def updateChat(value:str):
    ...
    chatNameLabel = Label(chatNameFrame,text=("Chat Name: " + chat + " Chat Id: " + ChatsId),bg="#CBC9EB",relief=FLAT, font = test)
    chatNameLabel.pack()
    printUsers(users)
...
createChatButton = Button(userFunctionFrame,relief=RAISED,bg="#8EB5F0", text = "Create Chat",command=createChat, font = test)
